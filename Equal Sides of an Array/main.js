...
function findEvenIndex(arr){
  ...
  for(i = 0; i < arr.length; i++) {
    ...
    leftHalf = arr.slice(0, i).reduce((t, c) => t + c ,0)

    rightHalf = arr.slice(i + 1).reduce((t, c) => t + c ,0)

    if(leftHalf == rightHalf) { equalSides.push(i)}
  }

  return equalSides[0] === undefined ? -1 : equalSides[0]
}

console.log(findEvenIndex([6, -3, 3, 3, 0]))
console.log(findEvenIndex([1, 2, 3, 4, 5 ]))
